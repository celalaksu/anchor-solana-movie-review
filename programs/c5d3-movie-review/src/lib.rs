...
declare_id!("59aXGszp71gKMND83XNfywpozaxVUJC1feyxFs227BYe");
...
pub mod movie_review {
    ...
    pub fn add_movie_review (
        ...
        if rating > 5 || rating < 1 {
            msg!("Rating cannot be higher than 5 and lower than 1");
            return err!(ErrorCode::InvalidRating);
        }

        let movie_review = &mut &mut ctx.accounts.movie_review;
        ...
        msg!("Comment Counter: {}", movie_comment_counter.counter);
